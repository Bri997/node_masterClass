...
//Perform the check, send the orginal checkcdata and the outcome of the check process to the next step in the process
...
workers.procesCheckOutcome = function(originalCheckData, checkOutcome) {
  ...
  // Upadate the check data
  console.log(checkOutcome, state, alertWarrented);
...
workers.alertUserToStatusChange = function(newCheckData) {
  ...
  helpers.sendTwilioSms(newCheckData.userPhone, msg, function(err) {
    if (!err) {
      console.log(
        "Success: User was alerted to status change in their check via SMS",
        msg
      );
    } else {
      console.log(
...
// Log the outcome
// console.log(newCheckData, checkOutcome, state, alertWarrented, timeOfCheck);
